const DATA = {
  ...
  programs: [
    ...
    {
      id: 'upperlower', name: 'Upper / Lower', desc: '4 jours (lun-mar-jeu-ven). A = force (lourd, peu de reps), B = volume (léger, plus de reps).',
      days: [
        { name: '⬆️ Upper A (Force)', exercises: [
          { name: 'Développé couché barre', sets: 4, reps: '5-6', lastSetTechnique: 'rest-pause' },
          { name: 'Rowing barre buste penché', sets: 4, reps: '5-6', lastSetTechnique: 'rest-pause' },
          { name: 'Développé militaire barre', sets: 3, reps: '6-8', lastSetTechnique: 'negative' },
          { name: 'Curl biceps haltères', sets: 3, reps: '8-10', lastSetTechnique: '21' },
          { name: 'Dips sur banc (triceps)', sets: 3, reps: '8-10', lastSetTechnique: 'rest-pause' },
        ]},
        { name: '⬇️ Lower A (Force)', exercises: [
          { name: 'Squat barre', sets: 4, reps: '5-6', lastSetTechnique: 'rest-pause' },
          { name: 'Soulevé de terre roumain haltères', sets: 3, reps: '8-10', lastSetTechnique: 'negative' },
          { name: 'Fentes haltères', sets: 3, reps: '8-10/jambe', lastSetTechnique: 'tempo' },
          { name: 'Mollets debout barre', sets: 4, reps: '12-15', lastSetTechnique: 'iso-hold' },
          { name: 'Relevé de jambes couché', sets: 3, reps: '12-15' },
        ]},
        { name: '⬆️ Upper B (Volume)', exercises: [
          { name: 'Développé incliné haltères', sets: 3, reps: '10-12', lastSetTechnique: 'dropset' },
          { name: 'Rowing un bras haltère', sets: 3, reps: '10-12', lastSetTechnique: 'peak' },
          { name: 'Élévations latérales haltères', sets: 4, reps: '12-15', lastSetTechnique: 'partial' },
          { name: 'Curl marteau haltères', sets: 3, reps: '12-15', lastSetTechnique: 'dropset' },
          { name: 'Kickback haltère triceps', sets: 3, reps: '12-15', lastSetTechnique: 'peak' },
        ]},
        { name: '⬇️ Lower B (Volume)', exercises: [
          { name: 'Goblet squat haltère', sets: 3, reps: '12-15', lastSetTechnique: 'tempo' },
          { name: 'Soulevé de terre barre', sets: 3, reps: '8-10' },
          { name: 'Fentes haltères', sets: 3, reps: '12-15/jambe', lastSetTechnique: 'negative' },
          { name: 'Mollets debout barre', sets: 4, reps: '15-20', lastSetTechnique: 'partial' },
          { name: 'Crunch', sets: 3, reps: '15-20', lastSetTechnique: 'iso-hold' },
        ]},
      ]
    }
  ],
