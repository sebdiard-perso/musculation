const DATA = {
  ...
  defaultExercises: [
    { id: 1, name: 'Développé couché barre', muscle: 'Pectoraux', video: 'https://www.youtube.com/watch?v=rT7DgCr-3pg' },
    { id: 2, name: 'Développé incliné haltères', muscle: 'Pectoraux', video: 'https://www.youtube.com/watch?v=8iPEnn-ltC8' },
    { id: 3, name: 'Écarté couché haltères', muscle: 'Pectoraux', video: 'https://www.youtube.com/watch?v=eozdVDA78K0' },
    { id: 4, name: 'Soulevé de terre barre', muscle: 'Dos', video: 'https://www.youtube.com/watch?v=op9kVnSso6Q' },
    { id: 5, name: 'Rowing barre buste penché', muscle: 'Dos', video: 'https://www.youtube.com/watch?v=T3N-TO4reLQ' },
    { id: 6, name: 'Rowing un bras haltère', muscle: 'Dos', video: 'https://www.youtube.com/watch?v=pYcpY20QaE8' },
    { id: 7, name: 'Shrug haltères (trapèzes)', muscle: 'Dos', video: 'https://www.youtube.com/watch?v=cJRVVxmytaM' },
    { id: 8, name: 'Développé militaire barre', muscle: 'Épaules', video: 'https://www.youtube.com/watch?v=2yjwXTZQDDI' },
    { id: 9, name: 'Élévations latérales haltères', muscle: 'Épaules', video: 'https://www.youtube.com/watch?v=3VcKaXpzqRo' },
    { id: 10, name: 'Élévations frontales haltères', muscle: 'Épaules', video: 'https://www.youtube.com/watch?v=gzDe-ELmhTE' },
    { id: 11, name: 'Oiseau haltères (arrière épaule)', muscle: 'Épaules', video: 'https://www.youtube.com/watch?v=ttvfGg9d76c' },
    { id: 12, name: 'Curl biceps haltères', muscle: 'Biceps', video: 'https://www.youtube.com/watch?v=ykJmrZ5v0Oo' },
    { id: 13, name: 'Curl marteau haltères', muscle: 'Biceps', video: 'https://www.youtube.com/watch?v=zC3nLlEvin4' },
    { id: 14, name: 'Curl concentré haltère', muscle: 'Biceps', video: 'https://www.youtube.com/watch?v=Jvj2wV0vOYU' },
    { id: 15, name: 'Dips sur banc (triceps)', muscle: 'Triceps', video: 'https://www.youtube.com/watch?v=6kALZikXxLc' },
    { id: 16, name: 'Kickback haltère triceps', muscle: 'Triceps', video: 'https://www.youtube.com/watch?v=6SS6K3lAwZ8' },
    { id: 17, name: 'Extension haltère au-dessus tête', muscle: 'Triceps', video: 'https://www.youtube.com/watch?v=_gsUck-7M74' },
    { id: 18, name: 'Squat barre', muscle: 'Jambes', video: 'https://www.youtube.com/watch?v=ultWZbUMPL8' },
    { id: 19, name: 'Fentes haltères', muscle: 'Jambes', video: 'https://www.youtube.com/watch?v=D7KaRcUTQeE' },
    { id: 20, name: 'Soulevé de terre roumain haltères', muscle: 'Jambes', video: 'https://www.youtube.com/watch?v=2SHsk9AzdjA' },
    { id: 21, name: 'Goblet squat haltère', muscle: 'Jambes', video: 'https://www.youtube.com/watch?v=MeIiIdhvXT4' },
    { id: 22, name: 'Mollets debout barre', muscle: 'Mollets', video: 'https://www.youtube.com/watch?v=gwLzBJYoWlI' },
    { id: 23, name: 'Crunch', muscle: 'Abdos', video: 'https://www.youtube.com/watch?v=Xyd_fa5zoEU' },
    { id: 24, name: 'Relevé de jambes couché', muscle: 'Abdos', video: 'https://www.youtube.com/watch?v=JB2oyawG9KI' },
